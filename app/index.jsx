...
const Home = () => {
  ...
  const data = [
    { key: '1', value: 'V1 Left #1' },
    { key: '2', value: 'V2 Left #4' },
    { key: '3', value: 'V3 Right #2' },
    { key: '4', value: 'V4 Left #6' },
    { key: '5', value: 'V3 Right #2' },
    { key: '6', value: 'V4 Right #7' },
  ];
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
        ...
        <CameraView mode="video" style={styles.camera} enableTorch={isPressed} ref={camRef}>
          <View style={styles.topMenu}>
            ...
            <SelectList
              ...
              dropdownStyles={{ width: 110, borderColor: 'white', top: 22, left: 10, height: 90 }}
              dropdownTextStyles={{ color: 'white', fontWeight: 600 }}
              placeholder={'V1'}
              search={false}
              arrowicon={<Icon name="chevron-down-outline" size={20} color="white" />}
            />
          </View>
      ...
      <View style={styles.resultsContainer}>
        <Animated.View style={[styles.resultsDisplay, { opacity: fadeAnim }]}>
          <Text style={styles.resultText}>Uploaded Video! Finding Beta...</Text>
        </Animated.View>
      </View>
